...
Now, let's generate the serializer that we can use with our `Contact` model...
...
Sure, we have a factory that will work, but I want some good old fashioned fake data. Open `specs/factories/contacts.rb`...
